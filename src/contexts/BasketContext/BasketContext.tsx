...
export { TinyBasket } from 'components/crystallize/elements/BasketTiny/BasketTiny'
...
export function BasketProvider({ children }) {
  const [{ cart, total, status, productsVariantsToExtend, metadata, changeTriggeredByChannel }, dispatch] = useReducer(
    reducer,
    initialState,
  )
    ...
    <BasketContext.Provider
      value={{
        ...
        actions: {
          ...
          setMetadata: (metadata) => dispatch({ action: 'set-metadata', metadata }),
